...
use Yii;
use app\models\{Parents, Students, User};
 ...
 */
class ParentsController extends DirectorsController
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->andWhere(['classes.school_id' => $this->_school->id])->orderBy(['user.name' => SORT_ASC]);
    ...
    public function actionDelete($id)
    {
        ...
        if ($this->findModel($id)->school->id == $this->_school->id && Yii::$app->user->identity->id !== $id && User::findOne($id)->type != 'admin') {
