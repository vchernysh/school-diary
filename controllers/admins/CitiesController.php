 ...
 */
class CitiesController extends AdminsController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionDelete($id)
    {
        ...
        $city = $this->findModel($id)->name;

        $this->findModel($id)->delete();

        Yii::$app->session->setFlash('success', '<strong>Успішно</strong>! Видалено місто <strong>"' . $city . '"</strong>.');
