...
class Nav_parents extends Widget // Widget for parents navigation;
{
            ...
            $__nav_single_paid = Nav::widget([
                ...
                'items' => [
                    ['label' => 'Школа <i class="fa fa-university" aria-hidden="true"></i>', 'encode' => false, 'url' => ['#'], 'options' => ['class' => 'school_dropdown'], 'items' => [
                        ['label' => 'Список учителів', 'url' => ['/parents/teachers/index']],
                        ['label' => 'Список класів та розклад', 'url' => ['/parents/classes/index']],
                        ['label' => 'Список предметів школи', 'url' => ['/parents/subjects/index']],
                        ['label' => 'Розклад дзвінків', 'url' => ['/parents/calls-schedule/index']],
                        '<li class="divider"></li>',
                        ['label' => 'Персонал школи', 'url' => ['/parents/school-staff/index']],
                        ['label' => 'Інформація про школу', 'url' => ['/parents/info-about-school/view']],
                    ...
                    ['label' => 'Мій клас <i class="fa fa-graduation-cap" aria-hidden="true"></i>', 'encode' => false, 'url' => ['#'], 'items' => [
                        ['label' => 'Налаштування <i class="fa fa-gears" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/settings/index']],
                        ['label' => 'Учні <i class="fa fa-child" aria-hidden="true"></i><i class="fa fa-child" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/students/index']],
                        ['label' => 'Батьки <i class="fa fa-users" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/parents/index']],
                        ['label' => 'Предмети <i class="fa fa-book" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/subjects']],
                        ['label' => 'Розклад <i class="fa fa-list-ul" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/schedule']],
                        ['label' => 'Успішність <i class="fa fa-line-chart" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-class/rating/index']],
                        '<li class="divider"></li>',
                        ['label' => 'Моя сім\'я <i class="fa fa-home" aria-hidden="true"></i>', 'encode' => false, 'url' => ['/parents/my-family/index']],
                    ]],
                    // ['label' => 'Повідомлення від учителів <i class="fa fa-envelope" aria-hidden="true"></i>', 'encode' => false, 'url' => ['#'], 'items' => [
                    //     ['label' => 'Домашні завдання', 'url' => ['/parents/new-homework']],
                    //     ['label' => 'Інші повідомлення', 'url' => ['/parents/other-messages']],
                    // ]],
