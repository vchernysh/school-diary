...
<div class="students-form">
    ...
    <?= $form->field($model, 'class_id')->dropDownList(ArrayHelper::map($classes, 'id', 'name'), ['prompt' => ['text' => ($classes) ? 'Виберіть клас' : 'В даній школі незареєстровано жодного класу. Створіть їх спочатку!', 'options'=> ['disabled' => true, 'selected' => true]]]) ?>
