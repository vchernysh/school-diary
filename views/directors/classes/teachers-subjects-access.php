...
$this->title = 'Доступ вчителів до предметів: ' . $model->name;
...
<div class="teachers-subjects-access-view">
    ...
    <?php if (!$class_subjects) { ?>
        <code>Необхідно додати хоча б один предмет до класу. Зробити це можна за наступним посиланням: <?= Html::a(Url::to(['subjects', 'id' => $model->id], true), Url::to(['subjects', 'id' => $model->id], true)) ?></code>
        <br><br>
    <?php } ?>
