        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'format' => 'html',
                    'value' => function($data) {
                        return '<img alt="' . $data->user->username . '" title="' . $data->user->name . '" class="user_image" src="' . $data->user->image . '">';
                    }
                ],
                [
                    'attribute' => 'user_id',
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'label' => '<p class="underline">Інформація про учня</p>',
                    'format' => 'html',
                    'value' => '<p class="underline">Інформація про учня</p>',
                ],
                [
                    ...
                    'format' => 'html',
                    'value' => function($data) {
                        return '<img alt="' . $data->child_user->username . '" title="' . $data->child_user->name . '" class="user_image" src="' . $data->child_user->image . '">';
                    }
                ],
                [
                    'attribute' => 'child_id',
                ...
                [
                    ...
                    'contentOptions' => ['style' => ['vertical-align' => 'middle']],
                    'value' => function($data) {
                        return Html::a($data->class->name, ['/directors/classes/view', 'id' => $data->class->id], 
                            ['target' => '_blank']);
                    }
                ],
                [
                    ...
                    'contentOptions' => ['style' => ['vertical-align' => 'middle']],
                    'value' => function($data) {
                        return Html::a($data->class_teacher->name, ['/directors/teachers/view', 'id' => $data->class_teacher->id], 
                            ['target' => '_blank']);
                    }
                ],
                [
