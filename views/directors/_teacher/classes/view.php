            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => function($data) {
                        if (!$data->teacher_name) {
                            ...
                            return Html::a($data->teacher_name . ' - ' . $data->subject->subject, ['/directors/teachers/teachers/view', 'id' => $data->teacher->id], ['target' => '_blank']);
                        }
                    },
                ],
                'count_of_students',
                ...
                [
                    ...
                    'value' => function($data) {
                        ...
                        $html = "<ul>\n";
                        $html .= "<li><a target=\"_blank\" href=\"" . Url::to(['/directors/teachers/teachers/view', 'id' => $data->teacher->id]) . "\">" . $data->teacher_name . " - " . $data->subject->subject . "</a></li>\n";
                        $html .= "<ul>Усі предмети</ul>\n";

                        foreach($data->teachers_subjects as $teacher) :
                            $html .= "<li><a target=\"_blank\" href=\"" . Url::to(['/directors/teachers/teachers/view', 'id' => $teacher['id']]) . "\">" . $teacher['name'] . "</a></li>\n";
