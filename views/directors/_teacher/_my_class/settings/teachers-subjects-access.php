...
<div class="teachers-subjects-access-view">
    ...
    <?php if (!$class_subjects) { ?>
        <code>Необхідно додати хоча б один предмет до класу. Зробити це можна за наступним посиланням: <?= Html::a(Url::to(['/directors/teachers/my-class/subjects'], true), Url::to(['/directors/teachers/my-class/subjects'], true)) ?></code>
        <br><br>
    <?php } ?>
