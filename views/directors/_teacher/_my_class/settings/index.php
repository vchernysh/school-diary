...
<div class="classes-view">
    ...
    <p class="paragraph_with_links">
        <?= Html::a('Додати предмети до класу', ['/directors/teachers/my-class/subjects'], ['class' => 'btn btn-success']) ?>
    ...
    <p class="paragraph_with_links">
        <?= Html::a('Розклад уроків класу', ['/directors/teachers/my-class/schedule'], ['class' => 'btn btn-info']) ?>
    </p>
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => function($data) {
                        return Html::a('Список учнів', ['/directors/teachers/my-class/students/index'], ['class' => 'btn btn-primary']);
                    },
                ],
                [
                    'attribute' => 'subjects',
                ...
                [
                    ...
                    'value' => function($data) {
                        ...
                        $html = "<ul>\n";
                        $html .= "<li><a target=\"_blank\" href=\"" . Url::to(['/directors/teachers/teachers/view/' . $data->teacher->id]) . "\">" . $data->teacher_name . " - " . $data->subject->subject . "</a></li>\n";
                        $html .= "<ul>Усі предмети</ul>\n";

                        foreach($data->teachers_subjects as $teacher) :
                            $html .= "<li><a target=\"_blank\" href=\"" . Url::to(['/directors/teachers/teachers/view/' . $teacher['id']]) . "\">" . $teacher['name'] . "</a></li>\n";
