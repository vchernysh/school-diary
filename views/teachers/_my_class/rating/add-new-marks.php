...
$this->params['breadcrumbs'][] = ['label' => 'Оцінки - ' . $subject->subject_name, 'url' => ['marks', 'subject_id' => $subject_id]];
...
<div class="add-new-marks-form">
	...
	<?= Html::hiddenInput('hidden_class_id', $class_id, ['class' => 'adding-marks-class-id']); ?>
