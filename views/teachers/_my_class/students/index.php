...
$this->title = 'Мій клас - ' . Yii::$app->user->identity->class->name . ' (Учні)';
                    ...
                    'buttons' => [
                        'delete' => function($url, $model) {
                            return Html::a('<i class="fa fa-trash-o control-label fa-school_diary" aria-hidden="true"></i>', ['delete', 'id' => $model->user_id], [
                                ...
                                'title' => 'Видалити',
                                'data' => [
                                    'confirm' => 'Ви дійсно хочете видалити учня "' . $model->name . '"? Усі дані стосовно цього учня будуть видалені, включаючи його батьків, які зареєстровані у системі School Diary.',
                                    'method' => 'post',
                                ],
                            ]);
                        },
