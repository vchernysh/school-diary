...
$this->params['breadcrumbs'][] = ['label' => 'Мій клас - ' . Yii::$app->user->identity->student_class->name . ' (Батьки)', 'url' => ['index']];
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'format' => 'html',
                    'value' => function($data) {
                        return '<a href="' . $data->child_user->image . '" title="' . $data->child_user->name . '" class="fancybox" rel="gallery_1">
                ...
                [
                    ...
                    'contentOptions' => ['style' => ['vertical-align' => 'middle']],
                    'value' => function($data) {
                        return Html::a($data->class_teacher->name, ['/students/teachers/view', 'id' => $data->class_teacher->id]);
                    }
                ],
                [
