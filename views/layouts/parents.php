...
use app\widgets\{Alert, Footer_questions_modal, Nav_parents, Empty_telegram, Not_payment, LiqPayAboveFooter};
...
<head>
    ...
    <?php $this->registerCssFile('@web/css/parents.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>
...
<div class="wrap">
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            <span class="active"><?= Yii::$app->user->identity->children->name ?>: <?= Yii::$app->user->identity->children->class->name ?> - <?= Yii::$app->user->identity->school->name ?>, <?= Yii::$app->user->identity->city->name ?>, <?= Yii::$app->user->identity->region->name ?></span>
        </div>
...
<footer class="footer footer-not-main">
    <div class="container">
        ...
        <wrapper id="footer_wrapper">
            <a href="https://teleg.run/SchoolDiaryParents_bot" class="footer_popover" target="_blank">
                <div class="pulse">
