...
use app\widgets\{Alert, Footer_questions_modal, Nav_teachers, Empty_telegram, LiqPayAboveFooter};
...
<head>
    ...
    <?php $this->registerCssFile('@web/css/teachers.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>
...
<footer class="footer footer-not-main">
    <div class="container">
        ...
        <wrapper id="footer_wrapper">
            <a href="https://teleg.run/SchoolDiaryTeachers_bot" class="footer_popover" target="_blank">
                <div class="pulse">
