...
$this->title = 'Мій клас - ' . Yii::$app->user->identity->children->class->name . ' (Налаштування)';
...
<div class="classes-view">
    ...
    <p class="paragraph_with_links">
        <?= Html::a('Розклад уроків класу', ['/parents/my-class/schedule'], ['class' => 'btn btn-info']) ?>
    </p>
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => function($data) {
                        return Html::a($data->teacher_name . ' - ' . $data->subject->subject, ['/parents/teachers/view/', 'id' => $data->class_teacher_id]);
                    },
                ],
                'count_of_students',
                [
                    ...
                    'value' => function($data) {
                        return Html::a('Список учнів', ['/parents/my-class/students/index'], ['class' => 'btn btn-primary']);
                    },
                ],
                [
                    'attribute' => 'subjects',
                ...
                [
                    ...
                    'value' => function($data) {
                        ...
                        $html = "<ul>\n";
                        $html .= "<li><a href=\"" . Url::to(['/parents/teachers/view/' . $data->teacher->id]) . "\">" . $data->teacher_name . " - " . $data->subject->subject . "</a></li>\n";
                        $html .= "<ul>Усі предмети</ul>\n";

                        foreach($data->teachers_subjects as $teacher) :
                            $html .= "<li><a href=\"" . Url::to(['/parents/teachers/view/' . $teacher['id']]) . "\">" . $teacher['name'] . "</a></li>\n";
