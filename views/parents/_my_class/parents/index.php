...
$this->title = 'Мій клас - ' . Yii::$app->user->identity->children->class->name . ' (Батьки)';
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'headerOptions' => ['style' => ['vertical-align' => 'middle', 'text-align' => 'center']],
                    'value' => function($data) {
                        return Html::a($data->child_name, ['/parents/my-class/students/view', 'id' => $data->child->user_id]);
                    },
                ],
                // 'name',
                [
