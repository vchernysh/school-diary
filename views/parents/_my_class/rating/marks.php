...
$this->params['breadcrumbs'][] = ['label' => 'Мій клас - ' . Yii::$app->user->identity->children->class->name . ' (Успішність <i class="fa fa-line-chart" aria-hidden="true"></i>)', 'url' => ['index']];
...
<div class="flex-block marks-flex-block students-view-marks-flex-block-wrap">
	...
	<?= Html::dropDownList('subject', $subject_id, $subjects, ['class' => 'form-control select-subject-marks', 'onchange' => '
		$.post("/parents/my-class/rating/marks?subject_id='.'"+$(this).val());
	']) ?>
</div>
