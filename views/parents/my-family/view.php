...
$this->params['breadcrumbs'][] = ['label' => 'Моя сім\'я', 'url' => ['index']];
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'contentOptions' => ['style' => ['vertical-align' => 'middle']],
                    'value' => function($data) {
                        return Html::a($data->class->name, Url::to(['/parents/my-class/settings/index']));
                    }
                ],
                [
                    ...
                    'contentOptions' => ['style' => ['vertical-align' => 'middle']],
                    'value' => function($data) {
                        return Html::a($data->class_teacher->name, ['/parents/teachers/view', 'id' => $data->class_teacher->id]);
                    }
                ],
                [
